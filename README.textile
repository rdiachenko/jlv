...
h5. "Past releases":https://github.com/rdiachenko/JLV/issues/milestones?state=closed

h5. "Upcoming releases":https://github.com/rdiachenko/JLV/issues/milestones?state=open

h3. Client's log4j configuration
