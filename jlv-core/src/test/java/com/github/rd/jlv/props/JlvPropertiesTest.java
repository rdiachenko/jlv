...
public class JlvPropertiesTest {
	...
	public void testLoadDefault() {
		...
		Assert.assertEquals(4445, store.loadDefault(PropertyKey.SERVER_PORT_KEY));
		Assert.assertEquals(true, store.loadDefault(PropertyKey.SERVER_AUTOSTART_KEY));
		Assert.assertEquals(10000, store.loadDefault(PropertyKey.LOGLIST_BUFFER_SIZE_KEY));
		Assert.assertEquals(500, store.loadDefault(PropertyKey.LOGLIST_REFRESH_TIME_KEY));
		Assert.assertEquals(true, store.loadDefault(PropertyKey.LOGLIST_QUICK_SEARCH_KEY));
		Assert.assertEquals(11, store.loadDefault(PropertyKey.LOGLIST_FONT_SIZE_KEY));
	...
	public void testLoadFromFile() {
		...
		Assert.assertEquals(4446, store.load(PropertyKey.SERVER_PORT_KEY));
		Assert.assertEquals(false, store.load(PropertyKey.SERVER_AUTOSTART_KEY));
		Assert.assertEquals(7000, store.load(PropertyKey.LOGLIST_BUFFER_SIZE_KEY));
		Assert.assertEquals(100, store.load(PropertyKey.LOGLIST_REFRESH_TIME_KEY));
		Assert.assertEquals(false, store.load(PropertyKey.LOGLIST_QUICK_SEARCH_KEY));
		Assert.assertEquals(14, store.load(PropertyKey.LOGLIST_FONT_SIZE_KEY));
	...
	public void testSaveToFile() {
		...
		Assert.assertEquals(newPort, store.load(PropertyKey.SERVER_PORT_KEY));
		...
		store = new JlvProperties(TEST_FILE);
		Assert.assertEquals(oldPort, store.load(PropertyKey.SERVER_PORT_KEY));
