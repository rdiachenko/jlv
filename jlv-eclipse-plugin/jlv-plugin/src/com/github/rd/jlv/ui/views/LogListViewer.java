...
public class LogListViewer extends TableViewer {

	public LogListViewer(Composite parent, int style) {
		super(parent, style);
	...
	private void createColumns() {
		...
		for (int i = 0; i < headers.length; i++) {
			...
			case LogConstants.LEVEL_FIELD_NAME:
				column.setLabelProvider(new LevelColumnLabelProvider(this.getTable(), headers[i]));
				break;
